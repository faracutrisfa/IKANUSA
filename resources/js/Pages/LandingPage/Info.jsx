        ...
        <section className='px-10 lg:px-16 xl:px-24 bg-white py-16'>
            <div className='flex flex-col lg:flex-row gap-5 lg:gap-10'>
                ...
                <div id='info' className='space-y-4'>
                    ...
                    <ul id='total' className='order-1 lg:order-3 flex gap-6 lg:gap-12 bg-darker-blue text-white justify-center py-4 px-12 lg:w-3/4'>
                        <li className='flex flex-col items-center'><h1 className='font-bold lg:text-3xl'>2020</h1>Berdiri</li>
                        <li className='border-2 border-white'></li>
                        <li className='flex flex-col items-center'><h1 className='font-bold lg:text-3xl'>7000+</h1>Konsumen</li>
                        <li className='border-2 border-white'></li>
                        <li className='flex flex-col items-center'><h1 className='font-bold lg:text-3xl'>300+</h1>Mitra</li>
                    </ul>
                </div>
            </div>
        </section>
